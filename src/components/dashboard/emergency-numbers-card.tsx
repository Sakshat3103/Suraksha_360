    ...
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2 text-base">
          <ShieldAlert className="size-4.5 text-destructive" /> Government emergency numbers
        </CardTitle>
        <CardDescription>Straight to official responders — no app, no signup.</CardDescription>
      </CardHeader>
